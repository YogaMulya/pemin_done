    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Edit lokasi Aset</h1>
              ...
              <section class="row">
                ...
                <?php
                  $kode_lokasi = $_GET['id_lokasi'];
                  $query = $mysqli->query("SELECT * FROM lokasi_aset where id_lokasi='$kode_lokasi'");

                  while ($qu = mysqli_fetch_array($query)){
                    ?>
                  <!-- form sdasddtart -->
                  <form role="form" action="proseseditlokasiaset.php" method="post">
                  <div class = "box-body">
                  <div class ="form-group">
                    <label for="exampleInputEmail1">No</label>
                    <input type="text" disable value="<?php echo $qu['id_lokasi'] ?>" name="id_lokasi" class="form-control" placeholder="" disabled>
                    <input type="hidden" value="<?= $qu['id_lokasi']; ?>" name="id_lokasi">
                    </div>
                    <div class ="form-group">
                    <label for="exampleInputPassword1"> Nama lokasi </label>
                    <input type="text"  value="<?php echo$qu['lokasi'] ?>" name="lokasi"
            ...
            <a href="lokasi_aset.php" class="btn btn-danger">Back</a>
            </div>
            </form>
            </section><!-- /.content -->
