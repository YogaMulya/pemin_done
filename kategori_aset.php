...
<li class="dropdown">
  ...
  <!-- <li><a href="pengembalian.php"><i class="fa fa-book">&nbsp;&nbsp;&nbsp;Satuan</i></a></li>
  <br>  -->
  <!-- <li><a href="logout.php">dd<i class="fa fa-sign-out"></i> Logout</a></li> -->
  </ul>
    ...
    <div>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Daftar Kategori Aset </h2>
          <div class="row">
            <a href="tambahkategoriaset.php" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Tambah</a>
          </div>
              <table id="tabelbarang" class="table table-bordered table-hover">
                ...
                <?php
                     $query = $mysqli->query("SELECT * FROM kategori_aset ");
                    //  $id_kategori=1;
                     while ($lihat=mysqli_fetch_array($query)){
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $lihat['id_kategori']; ?></td>
                          
                          <td><?php echo $lihat['nama_kategori'];?></td>

                          
                          <td> <a href="editkategoriaset.php?id_kategori=<?php echo $lihat['id_kategori']; ?>" class="btn btn-danger">&nbsp;&nbsp;Edit</a>
                          <a href="hapuskategoriaset.php?id=<?php echo $lihat['id_kategori']; ?>" class="btn btn-danger">Hapus</a>
                          </td>
