    ...
    <div>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Daftar Aset</h2>
          <div class="row">
            <a href="tambahaset.php" class="btn btn-danger pull-right"><i class="fa fa-plus"></i>Tambah</a>
          </div>
              <table id="tabelbarang" class="table table-bordered table-hover">
                ...
                <?php
                     $query = $mysqli->query("SELECT * FROM aset ");
                     $id_brg=1;
                     while ($lihat=mysqli_fetch_array($query)){
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> <a href="editaset.php?kode_barang=<?php echo $lihat['kode_barang']; ?>" class="btn btn-danger">&nbsp;&nbsp;Edit</a>
                          <a href="hapusaset.php?id=<?php echo $lihat['kode_barang']; ?>" class="btn btn-danger">Hapus</a>
                          </td>
