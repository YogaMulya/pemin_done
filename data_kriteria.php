    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"> Keputusan Pengadaan</a>
        </div>
    ...
    <div>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row">
            <a href="tambahkriteria.php" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Tambah</a>
          </div>
                     ...
                     while ($lihat=mysqli_fetch_array($query)){
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> <a href="editkriteria.php?id_kriteria=<?php echo $lihat['id_kriteria']; ?>" class="btn btn-danger">&nbsp;&nbsp;Edit</a>
                          <a href="hapuskriteria.php?id=<?php echo $lihat['id_kriteria']; ?>" class="btn btn-danger">Hapus</a>
                          </td>
