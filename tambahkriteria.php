    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form role="form1" action="prosestambahkriteria.php" method="post">
             <table>
                 <div class = "box-body">
                    ...
                    <div class ="form-group">
                        ...
                        <input type="text"  name="id_kriteria" class="form-control" placeholder=" no kriteria ..." required>
                    </div>
                    <div class ="form-group">
                        <label for="exampleInputPassword1"> Kriteria </label>
                        <input type="text"  name="kriteria_tbl" class="form-control" placeholder=" masukan kriteria..." required>
                    </div>
                    <div class ="form-group">
             ...
             <a href="data_kriteria.php" class="btn btn-danger">Back </a>
               </div>
           </div>
        </div>
      </div>
