...
<li class="dropdown">
  ...
  <li><a href="pengembaliadn.php"><i class="fa fa-book">&nbsp;&nbsp;&nbsp;Satuan</i></a></li>
  <br> -->
  <!-- <li><a href="logout.php"><i class="fa fa-sign-out"></i> Logout</a></li> -->
  </ul>
    ...
    <div>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Daftar Satuan</h2>
          <div class="row">
            <a href="tambahsatuan.php" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Tambah</a>
          </div>
              <table id="tabelbarang" class="table table-bordered table-hover">
                ...
                <?php
                     $query = $mysqli->query("SELECT * FROM satuan ");
                     $id_brg=1;
                     while ($lihat=mysqli_fetch_array($query)){
                      ...
                      <tbody>
                        <tr>
                          ...
                          <!--  -->
                          <td> <a href="editsatuan.php?id_satuan=<?php echo $lihat['id_satuan']; ?>" class="btn btn-danger">&nbsp;&nbsp;Edit</a>
                          <a href="hapussatuan.php?id=<?php echo $lihat['id_satuan']; ?>" class="btn btn-danger">Hapus</a>
                          </td>
