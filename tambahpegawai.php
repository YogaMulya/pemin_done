...
<!-- <form class="navbar-form navbar-right">
  <input type="text" class="form-contdasdrol" placeholder="Search...">
</form> -->
</div>
</div>
    </nav>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form role="form1" action="prosestambahpegawai.php" method="post">
             <table>
                 <div class = "box-body">
                   ...
                   <div class ="form-group">
                        <label for="exampleInputPassword1">penempatan</label>
                        <input type="text"   name="penempatan"
                        class="form-control" placeholder="penempatan..." required>
                    </div>
