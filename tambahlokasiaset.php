    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Tambah lokasi Aset </h2>
          <form role="form1" action="prosestambahlokasiaset.php" method="post">
             <table>
                 <div class = "box-body">
                     <div class ="form-group">
                    </div>
                    <div class ="form-group">
                        <label for="exampleInputPassword1">kode lokasi Aset</label>
                        <input type="text"  name="kode_lokasi" class="form-control" placeholder=" kode lokasi ..." required>
                    </div>
                    <div class ="form-group">
