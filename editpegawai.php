              ...
              <section class="row">
                ...
                <?php
                  ...
                  while ($qu = mysqli_fetch_array($query)){
                    ?>
                  <!-- form sdasddtart -->
                  <form role="form" action="proseseditpegawai.php" method="post">
                  <div class = "box-body">
                  <div class ="form-group">
                    <label for="exampleInputEmail1">No</label>
                    <input type="text" disable value="<?php echo $qu['id_pegawai'] ?>" name="id_pegawai" class="form-control" placeholder="" disabled>
                    <input type="hidden" value="<?= $qu['id_pegawai']; ?>" name="id_pegawai">
                    </div>
                    <div class ="form-group">
                    ...
                    <input type="text"  value="<?php echo$qu['penempatan'] ?>" name="penempatan"
                    class="form-control" placeholder="" required>
                    </div>
                    <!-- <div class ="form-group">
