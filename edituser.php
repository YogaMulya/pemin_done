              ...
              <section class="row">
                ...
                <?php
                  ...
                  while ($qu = mysqli_fetch_array($query)){
                    ?>
                  <!-- form start -->
                  <form role="form" action="prosesedituser.php" method="post">
                  <div class = "box-body">
                  <div class ="form-group">
                    <label for="exampleInputEmail1">No</label>
                    <input type="text" disable value="<?php echo $qu['id_user'] ?>" name="id_user" class="form-control" placeholder="" disabled>
                    <input type="hidden" value="<?= $qu['id_user']; ?>" name="id_user">
                    </div>
                    <div class ="form-group">
                    ...
                    <input type="text"  value="<?php echo$qu['posisi'] ?>" name="posisi"
                    class="form-control" placeholder="" required>
                    </div>
                    <!-- <div class ="form-group">
