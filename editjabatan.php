        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Edit jabatan</h1>
              ...
              <section class="row">
                ...
                <?php
                  $id_jabat = $_GET['id'];
                  $query = $mysqli->query("SELECT * FROM jabatan where id_jabat='$id_jabat'");

                  while ($qu = mysqli_fetch_array($query)){
                    ?>
                  <!-- form sdasddtart -->
                  <form role="form" action="proseseditjabatan.php" method="post">
                  <div class = "box-body">
                  <div class ="form-group">
                    <label for="exampleInputEmail1">No</label>
                    <input type="text" disable value="<?php echo $qu['id_jabat'] ?>" name="id_jabat" class="form-control" placeholder="" disabled>
                    <input type="hidden" value="<?= $qu['id_jabat']; ?>" name="id_jabat">
                    </div>
                    <div class ="form-group">
                    <label for="exampleInputPassword1">Jabatan </label>
                    <input type="text"  value="<?php echo$qu['jabatan'] ?>" name="jabatan"
                    class="form-control" placeholder="" required>
                    </div>
                   
                    <!-- <div class ="form-group">
                      <label fornnnn="exampleInputPassword1">Kelas </label>
            ...
            <a href="jabatan_fungsional.php" class="btn btn-danger">Back</a>
            </div>
            </form>
            </section><!-- /.content -->
