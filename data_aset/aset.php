...
<li class="dropdown">
  ...
  <li><a href="peminjam.php"><i class="fa fa-user">&nbsp;&nbsp;&nbsp;Pegawai</i></a></li>
  <li><a href="peminjam.php"><i class="fa fa-user">&nbsp;&nbsp;&nbsp;Jabatan Fungsional</i></a></li>
  ...
  <ul class="dropdown-menu dropdown-user">
   <li class="divider"></li>
  <li><a href="data_aset/aset.php.php"><i class="fa fa-laptop">&nbsp;&nbsp;&nbsp;Aset</i></a></li>
  <li><a href="peminjam.php"><i class="fa fa-user">&nbsp;&nbsp;&nbsp;Kategori Aset</i></a></li>
  ...
  <ul class="dropdown-menu dropdown-user">
   <li class="divider"></li>
  <li><a href="barang.php"><i class="fa fa-laptop">&nbsp;&nbsp;&nbsp;Data Kriteria</i></a></li>
  ...
  <ul class="dropdown-menu dropdown-user">
   <li class="divider"></li>
  <li><a href="barang.php"><i class="fa fa-laptop">&nbsp;&nbsp;&nbsp;Hapus Aset</i></a></li>
  <!-- <li><a href="peminjam.php"><i class="fa fa-user">&nbsp;&nbsp;&nbsp;Data Aset</i></a></li> -->
  <!-- <li><a href="peminjaman.php"><i class="fa fa-gear">&nbsp;&nbsp;&nbsp;Lokasi Aset</i></a></li>
  <li><a href="pengembalian.php"><i class="fa fa-book">&nbsp;&nbsp;&nbsp;Satuan</i></a></li>
  <br> -->
  ...
  <ul class="dropdown-menu dropdown-user">
   <li class="divider"></li>
  <li><a href="barang.php"><i class="fa fa-laptop">&nbsp;&nbsp;&nbsp; Pegawai</i></a></li>
  <li><a href="peminjam.php"><i class="fa fa-user">&nbsp;&nbsp;&nbsp;Jabatan Fungsional</i></a></li>
  <li><a href="peminjaman.php"><i class="fa fa-gear">&nbsp;&nbsp;&nbsp;User </i></a></li>
  <!-- <li><a href="pengembalian.php"><i class="fa fa-book">&nbsp;&nbsp;&nbsp;Satuan</i></a></li>
  <br>  -->
  <!-- <li><a href="logout.php"><i class="fa fa-sign-out"></i> Logout</a></li> -->
  </ul>
