    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Tambah satuan </h2>
          <form role="form1" action="prosestambahsatuan.php" method="post">
             <table>
                 <div class = "box-body">
                    ...
                    <div class ="form-group">
                        ...
                        <input type="text"  name="kode_satuan" class="form-control" placeholder=" no satuan ..." required>
                    </div>
                    <div class ="form-group">
