    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form role="form1" action="prosestambahkategoriaset.php" method="post">
             <table>
                 <div class = "box-body">
                     <div class ="form-group">
                    </div>
                    <div class ="form-group">
                        <label for="exampleInputPassword1">kode Kategori Aset</label>
                        <input type="text"  name="kode_barang" class="form-control" placeholder=" kode kategori ..." required>
                    </div>
                    <div class ="form-group">
             ...
             <a href="kategoriaset.php" class="btn btn-danger">Back </a>
               </div>
           </div>
        </div>
      </div>
