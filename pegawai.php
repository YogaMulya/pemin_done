      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Daftar pegawai</h2>
           <a href="tambahpegawai.php" class="btn btn-danger pull-right" style="margin-bottom: 20px;"><i class="fa fa-plus"></i> Tambah</a>
                     ...
                     while ($lihat = mysqli_fetch_array($query)){
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="">
                            <!-- <a href="buku_pinjam.php?id_anggota=<?php echo $lihat['id_pegawai']; ?>" class="btn btn-danger">Lihat Barang <i class="fa fa-eye"></i></a> -->
                            <a href="editpegawai.php?id_pegawai=<?php echo $lihat['id_pegawai']; ?>" class="btn btn-danger">Edit</a>
                          </td>
                            <td>
                              <a href="hapuspegawai.php?id=<?php echo $lihat['id_pegawai']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                            </td>
